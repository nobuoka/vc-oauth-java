...
import info.vividcode.ktor.twitter.login.whatwg.parseWwwFormUrlEncoded
...
class ObtainTwitterTokenService(
    ...
    private fun authorize(
        ...
        val httpRequest = HttpRequest(unauthorizedRequest.method, unauthorizedRequest.url.toUrl())
